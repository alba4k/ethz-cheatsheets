...
\Def \key{Limes superior}: $\limsup\limits_{n\to\infty} a_n = \overline{\lim\limits_{n\to\infty}} a_n = \lim\limits_{n\to\infty} \sup\{a_k \, | \, k\ge n\}$
\key{Limes inferior}: $\liminf\limits_{n\to\infty} a_n = \mathop{\underline{\lim}}\limits_{n \to \infty} a_n = \lim\limits_{n\to\infty} \inf\{a_k \, | \, k\ge n\}$
