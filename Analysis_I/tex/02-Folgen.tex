...
\Satz Eigenschaften von monotone Folge
\begin{itemize}
...
\Def \key{Limes superior}: $\limsup\limits_{n\to\infty} a_n = \overline{\lim\limits_{n\to\infty}} a_n = \lim\limits_{n\to\infty} \sup\{a_k \, | \, k \geq n\}$
\key{Limes inferior}: $\liminf\limits_{n\to\infty} a_n = \mathop{\underline{\lim}}\limits_{n \to \infty} a_n = \lim\limits_{n\to\infty} \inf\{a_k \, | \, k \geq n\}$

\Satz Es gelten die folgenden Tatsachen:
\begin{itemize}
    \item $\limsup\limits_{n\to\infty} a_n = \inf\limits_{n\in\NN_0}(\sup\{a_k \, | \, k \geq n\})$
    \item $\liminf\limits_{n\to\infty} a_n = \sup\limits_{n\in\NN_0}(\inf\{a_k \, | \, k \geq n\})$
...
\Def \key{Cauchy-Folge}: $\forall \varepsilon > 0 \, \exists N \in \NN \, \forall m, n \geq N : |a_n - a_m| < \varepsilon$
