...
\begin{itemize}
    ...
    \item $\tan: \RR\backslash\{\frac{2k + 1}{2}\pi \,|\, k \in \ZZ\} \to \RR$
\end{itemize}
\end{minipage}
...
\begin{itemize}
    ...
    \item $\frac{1}{x}: (-\infty, 0) \cup (0, \infty) \to \RR\backslash\{0\}$, $\lim\limits_{x\to \pm \infty} \frac{1}{x} = 0$, $\lim\limits_{x\to 0^\pm} \ln x = \pm\infty$
\end{itemize}
\end{minipage}
