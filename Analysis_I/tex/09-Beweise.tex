...
\Bew \key{Mittelwersatz der Differentialrechnung}: Sei
...
\Bew \key{Mittelwersatz der Integralrechnung}: Da $f$ auf $[a, b]$ stetig, nimmt $f$ in $x_{min}, x_{max} \in [a, b]$
...
wegen Mittelwersatz der Integralrechnung. Da $\xi_h \to x$, $h \to 0$ und $f$ stetig gilt:
