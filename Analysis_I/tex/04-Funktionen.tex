...
\key{Linkstetigkeit} ist analog definiert
...
\Satz \key{Rechenregeln}: für $f,g: D \subset \RR \to \RR$, $c \in \RR$ gilt
\vspace{-0.6em}
\begin{itemize}
    \item $f + g$ ist stetig
    \item $f - g$ ist stetig
    ...
    $f \circ g$ stetig und $\lim\limits_{x\to x_0} g(f(x)) = g(\lim\limits_{f\to c}f(x_0))$
\end{itemize}
...
\begin{itemize}
    ...
    \item \key{lokales Extrema} falls lokales Minimum oder Maximum
\end{itemize}
