...
$a_n$ \key{Glieder}/\key{Elemente}/\key{Summanten}
...
\Satz \key{Vergleichskriterium}: Reihen $a_n, b_n, c_n \geq 0$,
$\exists N \in \NN \, \forall n \geq N : c_n \leq b_n \leq a_n$. Dann gilt:
\begin{itemize}
...
\Satz \key{Leibnitz Kriterium}: monoton fallende Nullfolge, $a_n \geq 0$.
Die \key{alternierende Reihe} $\sum_{n=0}^{\infty} (-1)^n a_n$ und es gilt:
$\sum_{n=0}^{2m+1} (-1)^n a_n \leq \sum_{n=0}^{\infty} (-1)^n a_n \leq \sum_{n=0}^{2m} (-1)^n a_n$ für alle $m \in \NN_0$

\Satz \key{Cauchy Kriterium}: Reihe konvergiert $\iff$ für alle $\varepsilon > 0$ existiert ein $N \in \NN_0$ so dass für $n \geq m \geq N$ gilt $|\sum_{k = m+1}^{n} a_k| \leq \varepsilon$

\Satz Jede absolut konvergente Reihe konvergiert

\Satz \key{Veralgemeinerte Dreiecksungleichung}: $\left\lvert\sum\limits_{n=0}^{\infty} a_n \right\rvert \leq \sum\limits_{n=0}^{\infty}|a_n|$

\Satz \key{Wurzel-Kriterium}: $\rho = \limsup\limits_{n\to\infty} \sqrt[n]{n} \in \RR \cup \{\infty\}$
\begin{itemize}
    \item $\rho < 1 \implies \sum_{n=0}^{\infty} a_n$ konvergiert absolut
    \item $\rho > 1 \implies \sum_{n=0}^{\infty} a_n$ divergiert
\end{itemize}

\Satz \key{Quotient-Kriterium}: $a_n \neq 0$, $\rho = \lim\limits_{n\to\infty} \frac{|a_{n+1}|}{|a_n|}$
\begin{itemize}
    \item $\rho < 1 \implies \sum_{n=0}^{\infty} a_n$ konvergiert absolut
    \item $\rho > 1 \implies \sum_{n=0}^{\infty} a_n$ divergiert
\end{itemize}
