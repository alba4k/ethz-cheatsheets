...
\Satz $\star$ \key{Summenformel für geom. Reihe} $a_n = a \cdot q^n$, $q \ne 1$, $N \in \NN_0$:
\vspace{-0.6em}
\begin{itemize}
    \item $\sum_{n=0}^{N} a_n = a \cdot \dfrac{1 - q^{N+1}}{1 - q}$
\end{itemize}

\Satz $\star$ \key{Geometrische Reihe} für $a_n = a \cdot q^n$: Für $|q| < 1$ konvergiert die Reihe und es gilt
\vspace{-0.6em}
\begin{itemize}
...
\Satz $\star$ \key{Summenformel für arithm. Reihe} für $a_n = a \cdot n + b$, $N \in \NN_0$:
\vspace{-0.6em}
\begin{itemize}
