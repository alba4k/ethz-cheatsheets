...
\Satz \key{Leibnitz Kriterium}: monoton fallende Nullfolge, $a_n\ge 0$.
...
\Satz \key{Veralgemeinerte Dreiecksungleichung}: $\left\lvert\sum\limits_{n=0}^{\infty} a_n \right\rvert\le \sum\limits_{n=0}^{\infty}|a_n|$
