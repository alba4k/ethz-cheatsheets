...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Mehrfache relle Nullstelle $(x -x_1)^m$: $\frac{A_1}{x - x_1} + \cdots + \frac{A_m}{(x - x_1)^m}$
...
\Satz $\star$ \key{Weirstrass-Substitution}: Nach der Substit. $t = \tan(\frac{x}{2})$ gilt:
