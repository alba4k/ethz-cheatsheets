...
\paragraph{D 2.4} Let $A\in\mathbb{R}^{\mxn}$ be a matrix,
...
\paragraph{D 2.9} Let $A \in \mathbb{R}^{\mxn}$. The \key{column space} $C(A)$ of $A$ is the span of the columns, $C(A):= \{Ax:x\in \mathbb{R}^n\} \subseteq \mathbb{R}^m$.

\paragraph{D 2.14} Let $A \in \mathbb{R}^{\mxn}$. The \key{row space} $R(A)$ of $A$ is the column space of the transpose, $R(A):=C(A^{\top})\subseteq\mathbb{R}^n$.

\paragraph{D 2.17} Let $A \in \mathbb{R}^{\mxn}$. The \key{nullspace} of $A$ is the set $N(A)=\{x\in\mathbb{R}^n : Ax=0\} \subseteq \mathbb{R}^n$.
...
transformation and $A \in \mathbb{R}^{\mxn}$ s.t. $T=T_A$. $\mathbf{Im}(T)=\mathbf{C}(A)$. $\mathbf{Ker}(T) = \mathbf{N}(A)$.

\subsection{CR decomposition}

\paragraph{T 2.46} Let $A\in\mathbb{R}^{\mxn}$ of rank $r$. Let $C$
